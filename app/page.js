      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center w-full mx-auto max-w-7xl px-4">
            <div className="pr-0 md:pr-20 mt-4 md:mt-0">
              <h1 className="text-2xl md:text-[42px] font-bold text-[#171717] text-center md:text-left leading-[32px] md:leading-[63px]">
                Build A Holistic Lifestyle With AmhexAfrica Therapy
              </h1>
        ...
        <section className="flex flex-col md:my-14 w-full mx-auto max-w-7xl px-5">
          ...
          <p className="text-center font-normal text-lg mt-5 self-center max-w-[900px] text-gray-700">
            ...
            AmhexAfrica, we provide you with the right expert who can help you
                ...
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      ...
                      have given me so much, AmhexAfrica
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      It’s my first time in this app and it’s quite cool! could
                      use this as a venting app or diary :]
                    </p>
                  </div>
                  <div className="">
                    <span className="text-lg font-medium italic">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      My past experiences with therapists made me scared to take
                      therapy but I am glad I took that leap of faith with
                      AmhexAfrica.
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      Yesterday I was crying a lot because I felt alone. Then i
                      downloaded this app and i am glad to have new family.
                      Thanks all of you
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      I cannot imagine not taking therapy now; it has changed my
                      life in ways I can never express, and this was only
                      possible because of AmhexAfrica.{" "}
                    </p>
                  </div>
                  <div className="">
                    <span className="text-lg font-medium italic">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <h5 className="font-bold text-xl mt-3">My comfort place</h5>
                    <p className="text-base font-normal text-gray-500 mt-6">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      Bro this app helped me so much I just want to thank all of
                      you for the help
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-6">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      I love the community I have over here. These people don’t
                      even know me and still are there to listen my rant, my
                      feelings. Extremely grateful for this app.
                    </p>
                  </div>
                  <div className="">
                    <span className="text-lg font-medium italic">
                ...
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      ...
                      this point of my life. Thnx AmhexAfrica and vrinda
                    </p>
                  </div>
                  <div className="">
                    <span className="text-lg font-medium italic">
              ...
              <div className="mx-3 mb-10">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <h5 className="font-bold text-xl mt-3">My special place</h5>
                    <p className="text-base font-normal text-gray-500 mt-6">
                  ...
                  <div className="">
                    <span className="text-lg font-medium italic">bhav210</span>
                  </div>
                </div>
              </div>
              <div className="mx-3 mb-10">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      Taking therapy from this app was the best decision I ever
                      made.
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-10">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      I appreciate the honesty of the people on this app. I have
                      had some beautiful conversations that have helped me
                      immensely. Great app
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-10">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      I never knew a therapist’s presence could actually make me
                      so warm from inside. Thank you, AmhexAfrica.
                    </p>
                  </div>
                  <div className="">
                    <span className="text-lg font-medium italic">
                ...
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between bg-gradient-to-br to-[rgba(23,23,23,0.2) from-[rgba(255,185,164,0.2)] to-[rgba(255,109,66,0)]">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      ...
                      to talk to and that did not work well with me. But thanks
                      to AmhexAfrica, I can talk as much as I want to and be me
                      again.
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="mx-3 mb-10">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <h5 className="font-bold text-xl mt-3">A true blessing</h5>
                    <p className="text-base font-normal text-gray-500 mt-6">
              ...
              <div className="mx-3 mb-10">
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <h5 className="font-bold text-xl mt-3">Wonderful people</h5>
                    <p className="text-base font-normal text-gray-500 mt-6">
                      Connecting with people on this app was absolutely amazing.
                      Thank you to everyone who I met on this app.
                    </p>
                  </div>
                  <div className="">
                    <span className="text-lg font-medium italic">
                ...
                <div className="p-6 rounded-2xl border border-gray-200 shadow-lg w-[350px] min-h-[300px] flex flex-col justify-between null">
                  <div className="">
                    ...
                    <p className="text-base font-normal text-gray-500 mt-6">
                      ...
                      us connect with ourselves without any judgment. Thank you,
                      AmhexAfrica.
                    </p>
                  </div>
                  <div className="">
              ...
              <div className="md:h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[#525252] text-center hidden md:block px-2">
                    Are negative thoughts taking you away from reality? Talk to
                    renowned experts and feel better right away.
                  </p>
                </div>
            ...
            <div className="flex flex-col justify-between ">
              ...
              <div className="md:h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[#525252] text-center hidden md:block px-2">
                    Not in the mood to feel your happy self? Share your thoughts
                    and concerns with experts and feel lighter instantly.
                  </p>
                </div>
                <div className="mt-4 text-center mx-2 md:mx-6 hidden md:block">
                  <a href="/services/sadness">
            ...
            <div className="flex flex-col justify-between ">
              ...
              <div className="md:h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[#525252] text-center hidden md:block px-2">
                    Not sure where life is headed? Consult industry experts and
                    get the answers to your questions right away.{" "}
                  </p>
                </div>
                <div className="mt-4 text-center mx-2 md:mx-6 hidden md:block">
                  <a href="/services/confusion">
              ...
              <div className="md:h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[#525252] text-center hidden md:block px-2">
                    ...
                    that help you feel peaceful in the unknown and take life as
                    it comes.
                  </p>
                </div>
                <div className="mt-4 text-center mx-2 md:mx-6 hidden md:block">
              ...
              <div className="md:h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[#525252] text-center hidden md:block px-2">
                    ...
                    atmosphere of unconditional support and bond with yourself.
                  </p>
                </div>
                <div className="mt-4 text-center mx-2 md:mx-6 hidden md:block">
                  <a href="/services/feeling-alone">
              ...
              <div className="md:h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-2 text-[#525252] text-center hidden md:block px-2">
                    ...
                    rejuvenate by connecting with professionals who can help you
                    maintain a steady work-life balance.
                  </p>
                </div>
                <div className="mt-4 text-center mx-2 md:mx-6 hidden md:block">
                  <a href="/services/burnout">
          ...
          <div className="bg-[#DFFDFF] rounded-[18px] flex flex-col lg:flex-row item-center gap-10 overflow-hidden">
            <div className="px-6 md:px-8 lg:pr-0 flex flex-col items-center lg:block py-6">
              <p className="font-bold text-2xl md:text-4xl text-[#171717] leading-[36px] md:leading-[40px] lg:leading-[48px] xl:leading-[56px] text-center lg:text-left">
                How Can AmhexAfrica Experts Help You?
              </p>
              <p className="my-3 lg:my-5 font-medium text-base text-[#525252] text-center lg:text-left">
                With anxiety and stress on the rise, the AmhexAfrica experts
            ...
            <div className="flex items-center flex-wrap gap-2 justify-center lg:hidden px-6 max-w-[500px] mx-auto">
              <div
                ...
                style={{
                  boxShadow: "0px 5.78232px 19.2744px 0px rgba(0, 0, 0, 0.16)",
                }}
              >
                <p>Anxiety</p>
                <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-6 gap-10 items-center bg-[#FFEBFF] rounded-[18px] mt-10 overflow-hidden">
            ...
            <div className="px-6 md:px-8 lg:pr-10 xl:pr-20 flex flex-col items-center lg:block pt-8 lg:pt-4 pb-0 lg:pb-4">
              ...
              <p className="my-3 lg:my-5 font-medium text-base text-[#525252] text-center lg:text-left">
                ...
                AmhexAfrica resources into your everyday routine and taking your
                healing journey to a whole new level.
              </p>
